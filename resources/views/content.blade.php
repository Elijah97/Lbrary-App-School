        ...
        <div class="row mato16 pad16 justify-content-center">
            <div class="col-6  pad10 ">
                <div class="Card16 col-12">
                    <div class="col-12">
                        <p class="Dash_Txt_Article black mato6 text-uppercase">Select Book to add Content</p>
                    </div>
                    <form class="form-horizontal pad32" action="/addContent" method="GET">
                        @csrf
                        @include('inc.messages')
                        <div class="row">
                            <select class="form-control input mabo16" name="bookKey">
